...
ActiveRecord::Schema.define(:version => 20130909190611) do
  ...
  create_table "categorys_companys", :force => true do |t|
  ...
  create_table "citys_companys", :force => true do |t|
    t.integer "city_id"
    t.integer "company_id"
  end
  ...
  create_table "companys", :force => true do |t|
    t.string   "name"
    t.string   "phone"
    t.string   "address"
    t.string   "website"
